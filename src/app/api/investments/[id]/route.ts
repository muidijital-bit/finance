...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  ).bind(body.name, body.symbol, body.type, body.quantity, body.buyPrice, body.currentPrice, body.interestRate ?? null, body.maturityDate ?? null, body.currency, body.date, id).run();
