...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  ).bind(b.title, b.lender ?? '', b.principal, b.totalAmount, b.installmentCount, b.installmentAmount, b.startDate, b.dueDay ?? 1, b.currency ?? 'TRY', b.note ?? '', b.isActive ? 1 : 0, b.paidCount ?? 0, params.id).run();
